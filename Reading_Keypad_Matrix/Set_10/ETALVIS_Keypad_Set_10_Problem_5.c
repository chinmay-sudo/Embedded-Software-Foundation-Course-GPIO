...
void loop() {
  ...
  while (1) {
    ...
    if (key) {
      ...
      if (key >= '0' && key <= '9') {
        if (num_flag == 0 && num1_flag < 3) {
          uint8_t digit = key - '0';
          num1 = num1*10 + digit;
          num1_flag++;

          digits[0] = 0;
          digits[1] = numbers[num1/100];
          digits[2] = numbers[(num1/10)%10];
          digits[3] = numbers[num1%10];
        } 
        else if (num_flag == 1 && num2_flag < 3) {
          uint8_t digit = key - '0';
          num2 = num2*10 + digit;
          num2_flag++;

          digits[0] = 0;
          digits[1] = numbers[num2/100];
